...
public class Host {
    ...
    public static final String KWYHOST = "keyhost_version_101";
    public static final String KWYFTPHOST = "keyftphost_version_101";
    public static final String KWYFTPHOSTIPTABLES = "keyftphostiptables_version_101";

    public static final String UPDATEKEYHOST = "updatehost_version_101";
